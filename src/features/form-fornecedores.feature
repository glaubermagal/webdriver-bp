Feature: Submitting "Cadastro do fornecedor" form
	...
	Scenario: Test with correct data
		When  I add "30.306.392/0001-82" to the inputfield "#content input[name=cnpj]"
            ...
            And   I select the option with the value "PB" for element "#content select[name=estado]"
            And   I add "21" to the inputfield "#content [name=ddd]"
            And   I add "33220000" to the inputfield "#content [name=phone-number]"
	...
	Scenario: Test all empty fields
		When  I click on the button "#content .button.medium"
	  	Then  I expect that element "#content .cnpj input" has the class "invalid"
            And   I expect that element "#content .razao-social input" has the class "invalid"
            And   I expect that element "#content .nome-fantasia input" has the class "invalid"
            And   I expect that element "#content .cnae input" has the class "invalid"
            And   I expect that element "#content .ramo-negocio input" has the class "invalid"
            And   I expect that element "#content .faturamento-mensal input" has the class "invalid"
            And   I expect that element "#content .capital-social input" has the class "invalid"
            And   I expect that element "#content .nome-responsavel input" has the class "invalid"
            And   I expect that element "#content .cpf input" has the class "invalid"
            And   I expect that element "#content .endereco input" has the class "invalid"
            And   I expect that element "#content .bairro input" does not have the class "invalid"
            And   I expect that element "#content .cep input" has the class "invalid"
            And   I expect that element "#content .cidade input" has the class "invalid"
            ...
            And   I expect that element "#content .email input" has the class "invalid"
            And   I expect that element "#content .website input" does not have the class "invalid"
